...
public class VentasGUI extends JFrame {
    ...
    private void aplicarEstilos() {
        ...
        JTextField[] campos = { textField2, textField3, textField4, cant_venta, subtotalf, textField8, buscarcliente, Ccedula, calendario, nombreE, idempleado, idcliente };
        ...
        JButton[] botones = { clickParaSeleccionarButton, agregarProductoButton, eliminarButton, cobrarButton, volverButton };
        ...
        productosventa.setFont(new Font("Serif", Font.PLAIN, 14));
        productosventa.setForeground(colorTexto);
        productosventa.setBackground(Color.WHITE);
        productosventa.setRowHeight(25);
        productosventa.getTableHeader().setFont(new Font("Serif", Font.BOLD, 15));
        productosventa.getTableHeader().setBackground(colorFondo);
        productosventa.getTableHeader().setForeground(colorTexto);

        datosproducto.setFont(new Font("Serif", Font.PLAIN, 14));
        datosproducto.setForeground(colorTexto);
        datosproducto.setBackground(Color.WHITE);
        datosproducto.setRowHeight(25);
        datosproducto.getTableHeader().setFont(new Font("Serif", Font.BOLD, 15));
        datosproducto.getTableHeader().setBackground(colorFondo);
        datosproducto.getTableHeader().setForeground(colorTexto);
    }
    ...
    public void psubtotal() {
        ...
        volverButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                MenuPrincipal menuPrincipal = new MenuPrincipal(); // Crea una nueva instancia de MenuPrincipal
                menuPrincipal.notifyAll(); // Muestra la ventana del menú principal
            }
        });volverButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
